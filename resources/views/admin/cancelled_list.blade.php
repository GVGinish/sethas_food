         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0">Cancelled List</h4>
               </div>
            </div>
         </div>
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title mb-0">Cancelled List</h4>
                  </div>
                  <!-- end card header -->
                  <div class="card-body">
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                              ...
                              <tbody class="list form-check-all">
                                 ...
                                 <tr>
                                    ...
                                    <td class="6 text-center">
                                       <span class="badge rounded-pill bg-danger p-2">{{ $all->status }}</span>
                                    </td>
                           ...
                           <div class="noresult" style="display: none">
                              <div class="text-center">
                                 ...
                                 <p class="text-muted mb-0">We've searched more than {{App\Models\OrderPlacedModel::where('status','Cancelled')->count()}} Orders We did not find any orders for you search.</p>
                              </div>
                           </div>
                        </div>
