                              ...
                              <tbody class="list form-check-all">
                                 ...
                                 <tr>
                                    ...
                                    <td class="6 text-center">
                                       ...
                                       <select name="status" class="form-control status-dropdown" data-id="{{ $all->billing_id }}">
...
<script>
   $(document).ready(function () {
       ...
       $('#modalConfirmButton').on('click', function () {
           ...
           var url = "{{ route('change_status', ['id' => ':id', 'status' => ':status']) }}"
       ...
       $('#modalCancelButton').on('click', function () {
           $('#statusModal').modal('hide');
           currentDropdown.find('option:first').prop('selected', true);  // Reset to "Change status" option
       });
